...
public interface Graph<T extends Vertex<T>> extends Iterable<T>{
	...
	/**
	 * <p>Returns a list of the vertices to be traversed to travel through this Graph 
	 * from t1 to t2. The listed vertices are in the proper order. {@code t1} and 
	 * {@code t2} are the first and last elements of the list, respectively.</p>
	 * @param t1
	 * @param t2
	 * @return
	 * @throws IllegalArgumentException if there is no path between {@code t1} and 
	 * {@code t2} in this Graph or if either {@code t1} or {@code t2} is not part 
	 * of this Graph
	 */
