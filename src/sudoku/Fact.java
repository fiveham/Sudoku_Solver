...
public abstract class Fact extends NodeSet<Claim,Fact>{
    ...
    /**
     * <p>The number ({@value}) of elements (neighbors) of a Rule that is a {@code xor}. A Rule is a
     * {@code xor} if it has two Claims, because exactly one of them is true and the other is false.
     * Given that the Rule is satisfied (the Rule is {@code true}), the Claims, as inputs to the
     * Rule, make such a Rule a {@code xor} operation on its neighbors.</p>
     */
