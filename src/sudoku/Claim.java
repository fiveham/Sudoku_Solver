...
public class Claim extends NodeSet<Fact,Claim>{
     ...
     * count of the kinds of FactBags that can hold the same Claim in common: a Rule for a cell, a
     * box, a column, and a row.</p>
     */
    ...
    /**
     * <p>Constructs a Claim at the specified {@code x}, {@code y}, and {@code symbol} coordinates,
     * pertaining to the specified {@code target}.</p>
    ...
    /**
     * <p>Returns true if this Claim has been set false and all its internal properties correspond
     * to that fact, false otherwise. No guarantee is made that formerly connected Facts reflect
     * this Claim's falsehood at the time this method is called; they may still contain a reference
     * to this Claim as a {@link #neighbors() neighbor}.</p>
     * @return true if this Claim is known to be false, false otherwise
     */
    ...
    /**
     * <p>Returns true if this Claim has been set true and all its internal properties correspond to
     * that fact, false otherwise.</p>
     * @return true if this Claim has been set true and all its internal properties correspond to
     * that fact, false otherwise
     */
     ...
     * @return a vector in claim-space from this Claim to {@code cn}
     */
